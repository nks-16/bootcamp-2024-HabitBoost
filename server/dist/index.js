...
const habitslog_1 = __importDefault(require("./routes/habitslog"));
const habitRouter_1 = __importDefault(require("./routes/habitRouter"));
...
app.use('/api/habitslogs', habitslog_1.default);
app.use('/api/habits', habitRouter_1.default);
// Start the server
app.listen(PORT, () => {
